...
const uint16_t PROGMEM thumbcombos_base_right[] = {LT(SYM, KC_TAB), LT(NUM, KC_SPC), COMBO_END};
const uint16_t PROGMEM thumbcombos_base_left[] = {LT(NAV, KC_BSPC), LT(MOUSE, KC_ENT), COMBO_END};
const uint16_t PROGMEM thumbcombos_nav[] = {KC_TAB, KC_SPC, COMBO_END};
const uint16_t PROGMEM thumbcombos_mouse[] = {KC_BTN1, KC_BTN3, COMBO_END};
const uint16_t PROGMEM thumbcombos_media[] = {KC_MSTP, KC_MPLY, COMBO_END};
const uint16_t PROGMEM thumbcombos_num[] = {KC_DOT, KC_MINS, COMBO_END};
  #if defined (MIRYOKU_LAYERS_FLIP)
const uint16_t PROGMEM thumbcombos_sym[] = {KC_UNDS, KC_LPRN, COMBO_END};
  #else
const uint16_t PROGMEM thumbcombos_sym[] = {KC_RPRN, KC_UNDS, COMBO_END};
  #endif
const uint16_t PROGMEM thumbcombos_fun[] = {KC_BSPC, KC_ENT, COMBO_END};
combo_t key_combos[COMBO_COUNT] = {
  COMBO(thumbcombos_base_right, LT(FUN, KC_ESC)),
  COMBO(thumbcombos_base_left, LT(MEDIA, KC_DEL)),
  COMBO(thumbcombos_nav, KC_ESC),
  COMBO(thumbcombos_mouse, KC_BTN2),
  COMBO(thumbcombos_media, KC_MUTE),
  COMBO(thumbcombos_num, KC_0),
  #if defined (MIRYOKU_LAYERS_FLIP)
